...
const char* default_SSID = "  "; // Nome da rede Wi-Fi esta em branco pois são informações pessoais 
const char* default_PASSWORD = "  "; // Senha da rede Wi-Fi esta em branco pois são informações pessoais 
const char* default_BROKER_MQTT = "  "; // IP do Broker MQTT  esta em branco pois são informações pessoais 
